...
/***/ function(module, exports, __webpack_require__) {
	...
	var _battleTag = __webpack_require__(160);

	var _battleTag2 = _interopRequireDefault(_battleTag);
	...
	_reactDom2.default.render(_react2.default.createElement(_battleTag2.default, null), document.querySelector('.app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BattleTag = function (_React$Component) {
		_inherits(BattleTag, _React$Component);

		function BattleTag() {
			_classCallCheck(this, BattleTag);

			return _possibleConstructorReturn(this, (BattleTag.__proto__ || Object.getPrototypeOf(BattleTag)).apply(this, arguments));
		}

		_createClass(BattleTag, [{
			key: 'render',
		...
		_createClass(Audio, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'audio',
						{ control: true, className: 'audio', autoPlay: this.props.autoplay },
